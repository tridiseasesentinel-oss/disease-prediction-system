...
class UnifiedDiseasePredictor:
    def __init__(self, model_dir="saved_models"):
        ...
        with open(os.path.join(self.model_dir, "diabetes_features.pkl"), "rb") as f:
        ...
        with open(os.path.join(self.model_dir, "heart_metadata.pkl"), "rb") as f:
        ...
        with open(os.path.join(self.model_dir, "obesity_metadata.pkl"), "rb") as f:
